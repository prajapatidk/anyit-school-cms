...
*Last updated: full project audit — accurate seed state (1 section), root/backend/frontend scripts, auth reload behavior, create-action UX quirk, PATCH reorder response shape, relation/field-key/DnD details, test coverage reality.*
